...
import { faCheck, faChevronDown, faChevronUp } from '@fortawesome/sharp-regular-svg-icons';
  ...
  return (
    ...
    >
      ...
      <span className='pointer-events-none text-muted-foreground'>
        <Icon className='text-xs' icon={faChevronDown} />
      </span>
    </SelectPrimitive.Trigger>
  )
}
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <Icon className='text-xs pointer-events-none' icon={faCheck} />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      {...props}
    >
      <Icon className='text-xs' icon={faChevronUp} />
    </SelectPrimitive.ScrollUpArrow>
  )
}
