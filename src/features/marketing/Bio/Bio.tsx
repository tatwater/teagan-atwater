...
import { faGrid5 } from '@fortawesome/sharp-solid-svg-icons';
  ...
  return (
    <section className={ styled.container }>
      ...
      <article className={ styled.about } id='about-me'>
        <h6 className={ styled.subnavHeading }><FontAwesomeIcon icon={ faGrid5 } /> In Depth</h6>
        ...
        <p>After VS Code, my next go-to tool is Figma. A love of good design has always been a core motivation (I was going to be an architect, more on that in a bit) and I design accessible user interfaces as well as build them.</p>
        <p>There's nothing quite as rewarding as making life more enjoyable for other people while also making their goals easier to achieve. Design and engineering are two inseparable sides of the same problem-solving coin, and I can't get enough of all of it.</p>
      </article>
