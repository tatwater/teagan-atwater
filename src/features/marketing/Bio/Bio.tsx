  ...
  return (
    <section className={ styled.container }>
      ...
      <article className={ styled.about } id='about-me'>
        ...
        <p>There's nothing quite as rewarding as making life more enjoyable for other people while making their goals easier to achieve. Design and engineering are two inseparable sides of the same problem-solving coin, and I can't get enough of all of it.</p>
      </article>
