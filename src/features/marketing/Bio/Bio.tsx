  ...
  return (
    <section className={ styled.container }>
      ...
      <article className={ styled.about } id='about-me'>
        ...
        <p>There's nothing quite like building better means for other people to accomplish their goals. Design and engineering are two inseparable sides of the same problem-solving coin, and I can't get enough of all of it.</p>
      </article>
