...
export const educationItems: ResumeItem[] = [
  {
    ...
    descriptionSummary: 'Double major with a dual focus on computational thinking and design. Graduated Honors with Distinction. Selected scholar for the interdisciplinary Ammerman Center for Arts and Technology. Founded an entrepreneurship club on campus, and active in the Cycling Club',
    descriptionFull:
