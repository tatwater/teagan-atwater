...
export const projectItems: ResumeItem[] = [
  ...
  },
  {
    ...
    descriptionSummary: 'Designed and built a social platform for home cooking across native desktop and web, including a git-style data model for branching/forking recipes, a canonical ingredient database, a web scraping and normalization pipeline, and a live \u201cplayer\u201d experience to help users prepare multiple dishes at once.',
    descriptionFull:
